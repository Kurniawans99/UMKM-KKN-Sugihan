...
export default function UmkmCard({ umkm }: { umkm: Umkm }) {
  const waLink = `https://wa.me/${umkm.no_whatsapp.replace(/[^0-9]/g, "")}`;

  return (
    <div className="bg-surface border border-border rounded-xl overflow-hidden card-hover group">
      {/* Image */}
      ...
      <div className="p-4 sm:p-5">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="btn-whatsapp flex-1 text-sm py-2.5 rounded-lg text-center font-semibold flex items-center justify-center gap-2"
            id={`wa-${umkm.id}`}
          >
